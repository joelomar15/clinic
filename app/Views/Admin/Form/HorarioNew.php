...
<div class="">
	...
	<form role="form" action="<?= base_url() ?>ad/horario" method="post" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-6">
				<div class="card">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="time" class="form-control" id="hora_inicio" name="hora_inicio" value="<?php echo set_value('hora_inicio') ?>">
							</div>
					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="time" class="form-control" id="hora_fin" name="hora_fin" value="<?php echo set_value('hora_fin') ?>">
							</div>
