...
<div class="">
	...
	<form role="form" action="<?= base_url('ad/asignar/' . $asignar['id']) ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group" style="padding-bottom: 3px;">
							...
							<select class="form-control select2" style="width: 100%;" name="doctor">
								...
								<?php foreach ($doctor as $doc): ?>
									<option value="<?php echo $doc['id']; ?>" <?php echo set_select('doctor',  $doc['id'],$doc['id']==$asignar['id_doctor']); ?>>
										<?php echo $doc['nombre']; ?>&nbsp;&nbsp;&nbsp;
									</option>
								<?php endforeach; ?>
							</select>
						...
						<div class="form-group" style="padding-bottom: 3px;">
							...
							<select class="form-control select2" style="width: 100%;" name="horario">
								...
								<?php foreach ($horario as $hor): ?>
									<option value="<?php echo $hor['id']; ?>" <?php echo set_select('horario', $hor['id'], $hor['id']==$asignar['id_horario']); ?>>
