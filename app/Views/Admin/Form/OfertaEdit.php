...
<div class="">
	...
	<form role="form" action="<?= base_url('ad/oferta/' . $oferta['id']) ?>" method="post" enctype="multipart/form-data">
					...
					<div class="card-body">
						<div class="form-group" style="padding-bottom: 3px;">
							...
							<select class="form-control select2" style="width: 100%;" name="producto">
								...
								<?php foreach ($producto as $pro): ?>
									<option value="<?php echo $pro['id']; ?>" <?php echo set_select('producto', $pro['id'],$pro['id']==$oferta['id_producto']); ?>>
										<?php echo $pro['nombre']; ?>&nbsp;&nbsp;&nbsp;
									</option>
								<?php endforeach; ?>
							</select>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="porcentaje" name="porcentaje" value="<?php echo set_value('porcentaje',$oferta['porcentaje']) ?>">
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo set_value('descripcion',$oferta['descripcion']) ?>">
							</div>
