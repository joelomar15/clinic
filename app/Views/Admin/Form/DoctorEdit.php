...
<div class="">
	...
	<form role="form" action="<?= base_url('ad/doctor/' . $doctor['id']) ?>" method="post" enctype="multipart/form-data">
					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo set_value('nombre', $doctor['nombre']) ?>">
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="cedula" name="cedula" value="<?php echo set_value('cedula', $doctor['cedula']) ?>">
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="direccion" name="direccion" value="<?php echo set_value('direccion', $doctor['direccion']) ?>">
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="email" class="form-control" id="email" name="email" value="<?php echo set_value('email', $doctor['correo']) ?>">
							</div>
					...
					<div class="card-body">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo set_value('telefono', $doctor['telefono']) ?>">
							</div>
							<small class="text-danger"><?php echo validation_show_error('telefono'); ?></small>
						</div>
						<div class="form-group">
							<label for="foto">Cambiar Fotografía (jpeg, jpg, png):</label>
